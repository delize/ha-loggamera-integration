...
Example:
  python ha_sensor_config_helper.py 05DEE511FE25F65555556JKHH87562 9729
"""
...
class HAConfigHelper:
    ...
    def generate_energy_dashboard_config(self):
        ...
        for value in values:
            ...
            if name == "ConsumedTotalInkWh" or "total förbrukning" in clear_name.lower():
                energy_consumption = self.generate_sensor_entity_id(name, clear_name)
                break
        
        if energy_consumption:
            energy_config.append(f"""
    ...
    def generate_all_configs(self):
        ...
        with open(self.output_file, "w") as f:
            ...
            if automations:
                ...
                f.write("# Add these to your automations.yaml or use the Automation Editor\n\n")
...
def main():
    """Run the script."""
    parser = argparse.ArgumentParser(description='Home Assistant Loggamera Sensor Configuration Helper')
